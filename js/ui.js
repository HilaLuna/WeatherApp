...
function updateUI(data, selectors) {
    ...
    selectors.weatherTemperature.innerHTML = `${data.main.temp.toFixed()}&#176` //toFixed yuvarlamaya yarıyor.
    selectors.weatherIcon.innerHTML = `<img src="https://openweathermap.org/img/wn/${data.weather[0].icon}@2x.png"/>`
    /*Maliyetli olduğu için API'de img tutmuyorlar yani veri tabanında. O sebeple böyle link ekliyorlar. */
